...
public abstract class AbstractSequenceClassifier<IN extends CoreMap> implements Function<String, String> {
   ...
   * @return A {@link java.util.List} of {@link Triple}s, each of which gives an entity
   ...
   *         extends {@link CoreMap} where each {@link java.util.List} refers to a
   *         document/sentence.
   */
  ...
  /**
   * Classify a {@link java.util.List} of something that extends{@link CoreMap}.
   * The classifications are added in place to the items of the document,
   * which is also returned by this method
   *
   * @param document A {@link java.util.List} of something that extends {@link CoreMap}.
  ...
  /**
   * Classify a {@link java.util.List} of something that extends {@link CoreMap} using as
   ...
   *
   * @param documents A {@link java.util.List} of {@link java.util.List} of something that extends
   *          {@link CoreMap}.
   */
