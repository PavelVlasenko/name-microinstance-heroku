...
public class QuantifiableEntityNormalizer {
  ...
  /**
   * Takes the output of an {@link edu.stanford.nlp.ie.AbstractSequenceClassifier} and marks up
   ...
   * attribute.
   *
   * @param l a {@link java.util.List} of {@link java.util.List}s of {@link CoreLabel}s
