 ...
 * {@link edu.stanford.nlp.ie.crf.CRFClassifier#getClassifier(String)} methods, which return a
...
public class CRFClassifier<IN extends CoreMap> extends AbstractSequenceClassifier<IN> {
  ...
  /**
   * Takes a {@link java.util.List} of something that extends {@link CoreMap} and prints
   * the likelihood of each possible label at each point.
   *
   * @param document A {@link java.util.List} of something that extends CoreMap.
   ...
   *
   * @param documents A {@link java.util.List} of {@link java.util.List} of INs.
   */
  ...
  /**
   * Takes a {@link java.util.List} of documents and prints the factor table
   * at each point.
   *
   * @param documents A {@link java.util.List} of {@link java.util.List} of INs.
   */
   ...
   *
   * @param document
   *          A {@link java.util.List} of something that extends {@link CoreMap}.
   */
