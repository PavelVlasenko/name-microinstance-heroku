...
public abstract class Tree extends AbstractCollection<Tree> implements Label, Labeled, Scored, Serializable {
   ...
   *          not copied).
   * @see #setChildren(edu.stanford.nlp.trees.Tree[])
   */
   ...
   * @see edu.stanford.nlp.trees.Tree#parent(edu.stanford.nlp.trees.Tree)
   */
  public Tree parent() {
    throw new UnsupportedOperationException();
  }
   ...
   * as in {@link #nodeNumber(edu.stanford.nlp.trees.Tree)}.
   *
