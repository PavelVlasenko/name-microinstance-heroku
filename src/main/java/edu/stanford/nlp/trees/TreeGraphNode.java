 ...
 * {@link edu.stanford.nlp.trees.Tree <code>Tree</code>}
 ...
 * {@link edu.stanford.nlp.ling.CoreLabel <code>CoreLabel</code>}
 *
...
public class TreeGraphNode extends Tree implements HasParent {
  ...
  /**
   * Uses the specified {@link edu.stanford.nlp.trees.HeadFinder <code>HeadFinder</code>}
   ...
   * in this node's {@link edu.stanford.nlp.ling.CoreLabel <code>CoreLabel</code>} and the
   * <code>CoreLabel</code>s of all its descendants.<p>
   * <p/>
   * Note that, in contrast to {@link edu.stanford.nlp.trees.Tree#percolateHeads
   ...
   * edu.stanford.nlp.ling.CoreLabel <code>CoreLabel</code>}.  (In contrast to {@link
   * edu.stanford.nlp.ling.CategoryWordTag
   ...
   * storing it in this node's {@link edu.stanford.nlp.ling.CoreLabel
