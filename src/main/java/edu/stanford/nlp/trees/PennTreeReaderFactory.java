...
/** Vends {@link edu.stanford.nlp.trees.PennTreeReader} objects.
 *
...
public class PennTreeReaderFactory implements TreeReaderFactory {
   ...
   * and a {@link edu.stanford.nlp.trees.TreeNormalizer}.
   */
  ...
  /**
   * Specify your own {@link edu.stanford.nlp.trees.TreeFactory};
   * uses a {@link PennTreebankTokenizer}, and a {@link edu.stanford.nlp.trees.TreeNormalizer}.
   *
  ...
  /**
   * Specify your own {@link edu.stanford.nlp.trees.TreeNormalizer};
