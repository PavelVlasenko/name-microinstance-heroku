 ...
 * {@link TsurgeonPattern} class and the {@link edu.stanford.nlp.trees.tregex.tsurgeon.Tsurgeon#parseOperation} method.
 * <p>
...
public class Tsurgeon {
   ...
   * @throws java.io.IOException If the usual kinds of IO errors occur
   */
