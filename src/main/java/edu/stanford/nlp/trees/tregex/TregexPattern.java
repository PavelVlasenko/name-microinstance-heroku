...
public abstract class TregexPattern implements Serializable {
  ...
  /**
   * Get a {@link edu.stanford.nlp.trees.tregex.TregexMatcher} for this pattern on this tree.  Any Relations which use heads of trees should use the provided HeadFinder.
   *
   * @param t a tree to match on
