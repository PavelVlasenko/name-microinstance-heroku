 ...
 * edu.stanford.nlp.trees.GrammaticalRelation <code>GrammaticalRelation</code>}, which
 ...
 * @see edu.stanford.nlp.trees.GrammaticalRelation
...
public abstract class GrammaticalStructure implements Serializable {
  ...
  /**
   * @see GrammaticalStructure#typedDependencies(edu.stanford.nlp.trees.GrammaticalStructure.Extras)
   */
  @Deprecated
  ...
  /**
   * @see GrammaticalStructure#typedDependenciesCollapsed(edu.stanford.nlp.trees.GrammaticalStructure.Extras)
   */
  @Deprecated
  ...
  /**
   * @see GrammaticalStructure#typedDependenciesCCprocessed(edu.stanford.nlp.trees.GrammaticalStructure.Extras)
   */
  @Deprecated
   ...
   * 
   * (see {@link #dependenciesToCoNLLXString(java.util.Collection, edu.stanford.nlp.util.CoreMap)})
   */
