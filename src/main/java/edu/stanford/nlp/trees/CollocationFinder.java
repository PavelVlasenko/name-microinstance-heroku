...
public class CollocationFinder {
   ...
   * The default {@link edu.stanford.nlp.trees.HeadFinder} is a {@link edu.stanford.nlp.trees.CollinsHeadFinder}.
   * @param t parse tree
   ...
   * @param t parse tree
   * @param w wordnet connection
   * @param hf {@link edu.stanford.nlp.trees.HeadFinder} to use
   */
