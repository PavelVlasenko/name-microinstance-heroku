...
/**
 * A Lexer interface to be used with {@link edu.stanford.nlp.process.LexerTokenizer}.  You can put a {@link java.io.Reader} inside
...
public interface Lexer {
  ...
  /**
   * put a {@link java.io.Reader} inside the Lexer.
   */
