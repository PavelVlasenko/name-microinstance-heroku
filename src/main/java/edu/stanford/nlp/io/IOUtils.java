...
public class IOUtils {
   ...
   *
   * @param name The file or resource name.
   * @return true if a call to {@link edu.stanford.nlp.io.IOUtils#getBufferedReaderFromClasspathOrFileSystem(String)} would return a valid stream.
   */
   ...
   * @throws java.io.IOException if there are exceptions opening the file
   */
   ...
   * @throws java.io.IOException If directory can't be created, is an existing file, or for other reasons
   */
   ...
   *  @return A Reader
   *  @throws java.io.IOException If any IO problem
   */
   ...
   * @see edu.stanford.nlp.io.IOUtils#cp(java.io.File, java.io.File, boolean)
   * @param source The source file. This is guaranteed to exist, and is guaranteed to be a file.
   * @param target The target file.
   * @throws java.io.IOException Throws an exception if the copy fails.
   */
   ...
   * @throws java.io.IOException If either the copy fails (standard IO Exception), or the command is invalid
  ...
  /** @see IOUtils#tail(java.io.File, int, String) */
   ...
   * @throws java.io.IOException Thrown from the underlying input stream.
   */
