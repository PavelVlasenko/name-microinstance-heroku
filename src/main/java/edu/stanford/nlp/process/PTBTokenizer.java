 ...
 * <p>
 * New code is encouraged to use the {@link #PTBTokenizer(java.io.Reader,LexedTokenFactory,String)}
...
public class PTBTokenizer<T extends HasWord> extends AbstractTokenizer<T> {
   ...
   *          {@link edu.stanford.nlp.ling.Word}
   */
   ...
   *  {@link edu.stanford.nlp.process.PTBTokenizer} for details of the parameters and options.
   *
   *  @see edu.stanford.nlp.process.PTBTokenizer
   ...
   * @throws java.io.IOException If any file I/O problem
   */
