...
public class WordToSentenceProcessor<IN> implements ListProcessor<IN, List<IN>> {
   ...
   * sentence boundary tokens their own tokens (e.g., {@link edu.stanford.nlp.process.PTBTokenizer}).
   *
   * @param words A list of already tokenized words (must implement HasWord or be a String).
   * @return A list of sentences.
   * @see #WordToSentenceProcessor(String, java.util.Set, java.util.Set, java.util.Set, String, edu.stanford.nlp.process.WordToSentenceProcessor.NewlineIsSentenceBreak, edu.stanford.nlp.ling.tokensregex.SequencePattern, java.util.Set, boolean, boolean)
   */
