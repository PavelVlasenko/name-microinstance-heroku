 ...
 * subclass.  It also defines most of the basic {@link edu.stanford.nlp.sequences.Clique}s
...
public abstract class FeatureFactory<IN> implements Serializable {
  ...
  /**
   * This method returns a {@link java.util.Collection} of the features
   * calculated for the word at the specified position in info (the list of
   * words) for the specified {@link edu.stanford.nlp.sequences.Clique}.
   ...
   * @return A {@link java.util.Collection} of the features
