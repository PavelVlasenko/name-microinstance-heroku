...
public class ObjectBankWrapper<IN extends CoreMap> extends ObjectBank<List<IN>> {
  ...
  /**
   * Take a {@link java.util.List} of documents (which are themselves {@link java.util.List}s
   * of something that extends {@link edu.stanford.nlp.util.CoreMap}, CoreLabel by default),
