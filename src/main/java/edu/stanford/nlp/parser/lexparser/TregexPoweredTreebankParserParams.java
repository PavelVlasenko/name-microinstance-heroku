...
/**
 * An extension of
 * {@link AbstractTreebankParserParams}
 ...
 *
 * @see #annotations
 * @see edu.stanford.nlp.parser.lexparser.TregexPoweredTreebankParserParams.SimpleStringFunction
 *
 * @author Jon Gauthier
 * @author Spence Green
 */
public abstract class TregexPoweredTreebankParserParams extends AbstractTreebankParserParams {
   ...
   *
   * @param featureName
   * @throws IllegalArgumentException If the provided feature
