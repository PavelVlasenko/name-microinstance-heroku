 ...
 * {@link edu.stanford.nlp.ling.CoreAnnotations} for more information.  This class exists
 * so that {@link edu.stanford.nlp.ling.CoreAnnotations} need not depend on timex classes,
