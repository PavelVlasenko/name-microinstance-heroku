 ...
 * edu.stanford.nlp.ling.IndexedWord} class. <p/>
 *
 ...
 * matched node using {@link edu.stanford.nlp.semgraph.semgrex.SemgrexMatcher#getNode(String o)} with (String)
 ...
 * Trying to do so will cause a {@link edu.stanford.nlp.semgraph.semgrex.ParseException} to be thrown. Named nodes
...
public abstract class SemgrexPattern implements Serializable {
  ...
  /**
   * Get a {@link edu.stanford.nlp.semgraph.semgrex.SemgrexMatcher} for this pattern in this graph.
   *
   * @param sg
  ...
  /**
   * Get a {@link edu.stanford.nlp.semgraph.semgrex.SemgrexMatcher} for this pattern in this graph, with some
