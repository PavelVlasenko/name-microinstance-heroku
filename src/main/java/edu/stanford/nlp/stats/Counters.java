...
/**
 * Static methods for operating on a {@link edu.stanford.nlp.stats.Counter}.
 * <p>
...
public class Counters {
   ...
   *
   * @param c The {@link edu.stanford.nlp.stats.Counter} to be L1 normalized. This counter is not
   *          modified.
   ...
   *
   * @param c The {@link edu.stanford.nlp.stats.Counter} to be L2 normalized. This counter is not
   *          modified.
   ...
   *
   * @param c The {@link edu.stanford.nlp.stats.Counter} to be L2 normalized. This counter is modified
   ...
   * with the largest counts in the given {@link edu.stanford.nlp.stats.Counter}, using the given
   * format string.
   *
   * @param c A Counter
