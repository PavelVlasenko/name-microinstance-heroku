...
public class IntCounter<E> extends AbstractCounter<E> implements Serializable {
   ...
   * use {@link #incrementCounts(java.util.Collection,int)}.
   */
   ...
   * 1, use {@link #incrementCounts(java.util.Collection)}.
   * <p/>
   * To set the counts of a collection of objects to a specific value instead
   * of incrementing them, use {@link #setCounts(java.util.Collection,int)}.
   */
   ...
   * than 1, use {@link #incrementCounts(java.util.Collection,int)}.
   * <p/>
   * To set the counts of a collection of objects  to a specific value instead
   * of incrementing them, use  {@link #setCounts(java.util.Collection,int)}.
   */
   ...
   * 1, use {@link #decrementCounts(java.util.Collection)}.
   * <p/>
   * To set the counts of a collection of objects to a specific value instead
   * of decrementing them, use {@link #setCounts(java.util.Collection,int)}.
   */
   ...
   * than 1, use {@link #decrementCounts(java.util.Collection,int)}.
   * <p/>
   ...
   * {@link #argmax(java.util.Comparator)}. Returns null if this Counter is empty.
   */
  public E argmax() {
   ...
   * This will prefer smaller numeric keys and lexicographically earlier
   * String keys. To use a different tie-breaking Comparator, use
   * {@link #argmin(java.util.Comparator)}. Returns null if this Counter is empty.
   */
  public E argmin() {
