...
/**
 * A class for keeping double counts of {@link java.util.List}s of a
...
public class GeneralizedCounter<K> implements Serializable {
   ...
   * java.util.List} of size equal to the depth of the GeneralizedCounter, and
  ...
  * to speed it up */
   ...
   * java.util.List} of size one less than the depth of the GeneralizedCounter, and
   * each value is a {@link edu.stanford.nlp.stats.ClassicCounter}.  Each entry is a {@link java.util.Map.Entry} object, but these objects
  ...
  * to speed it up */
   ...
   * {@link java.util.List} key in the GeneralizedCounter.
   *
   * @see #conditionalize(java.util.List)
   * @see #getCount
   */
  ...
  /**
   * Returns the set of keys, as read-only {@link java.util.List}s of size
  ...
  * to speed it up */
   ...
   * {@link java.util.List} argument. The length of the argument {@link java.util.List}
  ...
  /**
   * Like {@link edu.stanford.nlp.stats.ClassicCounter}, this currently returns true if the count is
   ...
   * <code>this</code> as a {@link edu.stanford.nlp.stats.ClassicCounter}.  Any calls to
  ...
  /**
   * Returns a read-only synchronous view (not a snapshot) of
   * <code>this</code> as a {@link edu.stanford.nlp.stats.ClassicCounter}.  Works only with one-dimensional
