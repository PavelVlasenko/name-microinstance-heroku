...
/**
 * This class provides a {@link edu.stanford.nlp.ling.CoreLabel} that uses its
...
public class IndexedWord implements AbstractCoreLabel, Comparable<IndexedWord> {
  ...
  /**
   * Default constructor; uses {@link edu.stanford.nlp.ling.CoreLabel} default constructor
   */
  public IndexedWord() {
    label = new CoreLabel();
  }
  ...
  /**
   * Copy Constructor - relies on {@link edu.stanford.nlp.ling.CoreLabel} copy constructor
