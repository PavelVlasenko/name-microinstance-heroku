 ...
 * class. e.g {@link edu.stanford.nlp.ling.CoreAnnotations.TextAnnotation}.class serves as the key and a
 * <code>String</code> serves as the value containing the
 * corresponding word.
 * </p>
 *
 * <p>
 * New types of {@link edu.stanford.nlp.ling.CoreAnnotation} can be defined anywhere that is
 ...
 * {@link edu.stanford.nlp.ling.Label} family. In general, most keys should be placed in this file as
 ...
 * info disappears at runtime. See {@link edu.stanford.nlp.ling.CoreAnnotations.ValueAnnotation} for an example.
 * </p>
 *
 * @author dramage
 * @author rafferty
