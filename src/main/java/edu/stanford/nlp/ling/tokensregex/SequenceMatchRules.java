 ...
 *       <td>String regular expression {@link java.util.regex.Pattern}</td></tr>
 ...
 *      Rules are applied with respect to an environment ({@link edu.stanford.nlp.ling.tokensregex.Env}), which can be accessed using the variable <code>ENV</code>.
 ...
 *   <tr><td><code>ENV</code></td><td>{@link edu.stanford.nlp.ling.tokensregex.Env}</td><td>The environment with respect to which the rules are applied.</td></tr>
 ...
 *      See {@link TokenSequencePattern} and {@link java.util.regex.Pattern} for
 ...
 *      Each action is a {@link edu.stanford.nlp.ling.tokensregex.types.Expressions TokensRegex Expression}</td></tr>
 *   <tr><td><code>result</code></td><td><code>&lt;Expression&gt;</code></td>
 *      <td><code></code></td><td>Resulting value to go into the resulting annotation.  See {@link edu.stanford.nlp.ling.tokensregex.types.Expressions} for how to specify the result.</td></tr>
