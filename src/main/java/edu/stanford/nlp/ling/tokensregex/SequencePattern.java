 ...
 * a {@link edu.stanford.nlp.ling.tokensregex.SequenceMatcher} object that can match arbitrary sequences of type T
 ...
 * <ul>
 *   <li>Implement a {@link edu.stanford.nlp.ling.tokensregex.NodePattern for matching type T}</li>
 *   <li>Optionally define a language for node matches and implement {@link edu.stanford.nlp.ling.tokensregex.SequencePattern.Parser} to compile a
 ...
 *   <li>Optionally implement a {@link edu.stanford.nlp.ling.tokensregex.SequencePattern.NodesMatchChecker} to support backreferences</li>
 * </ul>
 ...
 * <ol>
 * <li> Environment (see {@link edu.stanford.nlp.ling.tokensregex.Env}) with respect to which the patterns are compiled</li>
 * <li> Binding of variables
 * <br>Use {@link edu.stanford.nlp.ling.tokensregex.Env} to bind variables for use when compiling patterns
 * <br>Can also bind names to groups (see {@link SequenceMatchResult} for accessor methods to retrieve matched groups)
 * </li>
 * <li> Backreference matches - need to specify how back references are to be matched using {@link edu.stanford.nlp.ling.tokensregex.SequencePattern.NodesMatchChecker} </li>
 ...
 *
 * @author Angel Chang
 * @see edu.stanford.nlp.ling.tokensregex.SequenceMatcher
 */
public class SequencePattern<T> implements Serializable {
  ...
  public static interface Parser<T> {
    public PatternExpr parseSequence(Env env, String s) throws Exception;
    public Pair<PatternExpr, SequenceMatchAction<T>> parseSequenceWithAction(Env env, String s) throws Exception;
    public PatternExpr parseNode(Env env, String s) throws Exception;
  }
