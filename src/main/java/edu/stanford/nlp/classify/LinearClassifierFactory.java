...
public class LinearClassifierFactory<L, F> extends AbstractLinearClassifierFactory<L, F> {
  ...
  /**
   * Calls the method {@link #crossValidateSetSigma(edu.stanford.nlp.classify.GeneralDataset, int)} with 5-fold cross-validation.
  ...
  /**
   * Calls the method {@link #crossValidateSetSigma(edu.stanford.nlp.classify.GeneralDataset, int, edu.stanford.nlp.stats.Scorer, LineSearcher)} with
   * multi-class log-likelihood scoring (see {@link edu.stanford.nlp.stats.MultiClassAccuracyStats}) and golden-section line search
  ...
  /**
   * Set the {@link LineSearcher} to be used in {@link #heldOutSetSigma(edu.stanford.nlp.classify.GeneralDataset, edu.stanford.nlp.classify.GeneralDataset)}.
   */
