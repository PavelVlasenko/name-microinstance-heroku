 ...
 * builds a more memory-efficient representation of a {@link java.util.List} of
 * {@link edu.stanford.nlp.ling.Datum} objects for the purposes of training a {@link Classifier}
 * with a {@link ClassifierFactory}.
 *
 * @author Roger Levy (rog@stanford.edu)
 * @author Anna Rafferty (various refactoring with GeneralDataset/RVFDataset)
 * @author Sarah Spikes (sdspikes@cs.stanford.edu) (templatization)
 * @author nmramesh@cs.stanford.edu {@link #getL1NormalizedTFIDFDatum(edu.stanford.nlp.ling.Datum, edu.stanford.nlp.stats.Counter) and #getL1NormalizedTFIDFDataset()}
 *
 * @param <L> Label type
