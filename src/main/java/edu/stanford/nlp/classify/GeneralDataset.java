...
/**
 * The purpose of this interface is to unify {@link edu.stanford.nlp.classify.Dataset} and {@link edu.stanford.nlp.classify.RVFDataset}.
 * <p>
...
public abstract class GeneralDataset<L, F>  implements Serializable, Iterable<RVFDatum<L, F>> {
  ...
  /**
   * Returns the number of examples ({@link edu.stanford.nlp.ling.Datum}s) in the Dataset.
   */
