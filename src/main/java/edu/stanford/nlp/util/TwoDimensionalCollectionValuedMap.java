...
/**
 * A class which can store mappings from Object keys to {@link java.util.Collection}s of Object values.
 ...
 * The class is quite general, because on construction, it is possible to pass a {@link edu.stanford.nlp.util.MapFactory}
 * which will be used to create the underlying map and a {@link edu.stanford.nlp.util.CollectionFactory} which will
