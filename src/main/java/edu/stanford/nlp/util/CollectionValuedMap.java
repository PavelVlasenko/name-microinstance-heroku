...
/**
 * Map from keys to {@link java.util.Collection}s. Important methods are the {@link #add}
 ...
 * construction, it is possible to pass a {@link edu.stanford.nlp.util.MapFactory} which will be used
 * to create the underlying map and a {@link edu.stanford.nlp.util.CollectionFactory} which will be
...
public class CollectionValuedMap<K, V> implements Map<K, Collection<V>>, Serializable {
  ...
  /**
   * Unsupported. Use {@link #addAll(java.util.Map)} instead.
   */
