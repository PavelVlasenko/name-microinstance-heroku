 ...
 *
 * @author dramage
 * @author dlwh {@link #flatMap(Iterable, java.util.function.Function)}
...
public class Iterables {
  ...
  /**
   * Same as {@link #merge(Iterable, Iterable, edu.stanford.nlp.util.Iterables.IncrementComparator)} but using
  ...
  /**
   * Same as {@link #merge(Iterable, Iterable, Iterable, edu.stanford.nlp.util.Iterables.IncrementComparator, edu.stanford.nlp.util.Iterables.IncrementComparator)}
