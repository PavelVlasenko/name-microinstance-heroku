...
public class HashIndex<E> extends AbstractCollection<E> implements Index<E>, RandomAccess {
  ...
  /**
   * Looks up the objects corresponding to an array of indices, and returns them in a {@link java.util.Collection}.
   * This collection is not a copy, but accesses the data structures of the Index.
   *
   * @param indices An array of indices
   * @return a {@link java.util.Collection} of the objects corresponding to the indices argument.
   */
  @Override
  ...
  /**
   * Returns a complete {@link java.util.List} of indexed objects, in the order of their indices.  <b>DANGER!</b>
   ...
   *
   * @return a complete {@link java.util.List} of indexed objects
   */
  @Override
 ...
 @Override
   ...
   * @param objLookupFactory The constructor for the object lookup -- traditionally an {@link java.util.ArrayList}.
   * @param indexLookupFactory The constructor for the index lookup -- traditionally a {@link java.util.HashMap}.
   */
   ...
   * @throws java.io.IOException Exception thrown if cannot save.
   */
  @Override
