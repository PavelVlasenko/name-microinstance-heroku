...
/**
 * An extension of {@link edu.stanford.nlp.util.ArrayCoreMap} with an immutable set of key,value
...
public class HashableCoreMap extends ArrayCoreMap {
   ...
   * 
   * @throws edu.stanford.nlp.util.HashableCoreMap.HashableCoreMapException Attempting to set the value for an
